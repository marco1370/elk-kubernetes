...
# k3s-k8-log monitoring system
* Deploying ELK stack alongside fluentd to a k3s Managed Kubernetes (DOKS) cluster.
...
## Steps
1. Creating and setting up a Kubernetes Cluster in k3s
...
##  Creating and setting up a Kubernetes Cluster in k3s
* Follow the [Getting Started with kubernetes](https://docs.k3s.com/products/kubernetes/quickstart/) to set up our cluster. set up min of 3 node cluster
